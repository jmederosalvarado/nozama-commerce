...
import UserGroupIconSM from "../icons/heroicons/small/user-group";
        ...
        <div className="p-5 bg-white bg-opacity-75 backdrop-blur rounded-lg shadow-lg">
          <div className="flex items-center justify-center">
            ...
            <div className="flex items-center justify-center">
              ...
              <UserGroupIconSM className="text-indigo-600 w-4 h-4 ml-px" />
            </div>
            ...
            {editable && (
              <>
                <div className="border border-gray-600 bg-gray-600 h-4 mx-2"></div>
                <Link
                  href="/user/auctions/[id]"
                  as={`/user/auctions/${auction.id}`}
                >
          ...
          <div className="mt-2 w-full flex items-center justify-center">
            <Link href="/auctions/[id]" as={`/auctions/${auction.id}`}>
